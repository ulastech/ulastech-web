...
const CATEGORIES = [
  { name: "Tech Insights", topics: [
      { text: "tren kecerdasan buatan (AI) terbaru dan dampaknya ke gadget sehari-hari", imageQuery: "artificial intelligence technology" },
      { text: "perkembangan chip dan prosesor untuk perangkat mobile", imageQuery: "computer processor chip" },
      { text: "tren keamanan siber untuk pengguna gadget rumahan", imageQuery: "cyber security lock" },
      { text: "evolusi konektivitas (5G, WiFi 7, dst) dan dampaknya ke pengguna", imageQuery: "5G network tower" }
  ]},
  { name: "Smartphone", topics: [
      { text: "tips memilih smartphone sesuai kebutuhan (gaming, fotografi, produktivitas)", imageQuery: "smartphone hand person" },
      { text: "tren desain dan fitur kamera smartphone masa kini", imageQuery: "smartphone camera lens" },
      { text: "cara merawat baterai smartphone agar awet", imageQuery: "smartphone charging battery" }
  ]},
  { name: "Laptop & PC", topics: [
      { text: "tips memilih laptop untuk kerja, kuliah, atau gaming", imageQuery: "laptop computer desk" },
      { text: "tren laptop tipis dan hemat daya (ARM vs x86)", imageQuery: "thin laptop modern" }
  ]},
  { name: "Aksesoris & Daya", topics: [
      { text: "panduan memilih powerbank dan charger yang aman", imageQuery: "power bank charger" },
      { text: "tren aksesoris smart home dan gadget pendukung produktivitas", imageQuery: "smart home devices" }
  ]},
  { name: "Audio", topics: [
      { text: "panduan memilih earphone/headphone sesuai kebutuhan", imageQuery: "wireless earbuds headphones" },
      { text: "tren teknologi audio spatial dan noise cancelling", imageQuery: "headphones audio technology" }
  ]}
];
...
Balas HANYA dalam format JSON valid, tanpa markdown, tanpa teks tambahan, dengan struktur persis:
{
  ...
  const userPrompt = `Tulis artikel kategori "${cat.name}" dengan topik: ${topic.text}.`;
